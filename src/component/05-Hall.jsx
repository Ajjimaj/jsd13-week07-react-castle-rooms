...
export default function Hall({
  ...
  return (
    <div className="flex flex-col justify-center items-center pt-6 rounded-xl bg-emerald-800 text-white w-[96%] p-3 my-2 shadow-md">
      <h1 className="text-lg font-bold mb-1">Hall</h1>
